...
import { BirthdayConfig, CustomMessagePayload } from "@/types/db/birthday";
...
import { BIRTHDAY_TEMPLATE_CONFIG } from "@/utils/embedTemplates";
...
export function BirthdaysBody({
    ...
    // 1. Memoized default config to prevent render loops!
    ...
    const handleMsgChange = (updatedMsg: CustomMessagePayload) => {
                    ...
                    <>
                        ...
                        <div className="pt-4 border-t border-neutral-800 space-y-4">
                            ...
                            <MessageConfigEditor
                                key={activeTab}
                                config={{
                                    format: currentMsg?.format || ("TEXT" as Format),
