...
import { CounterChannel, MemberCounterConfig } from "@/types/db/config";
...
import { CounterType } from "@/types/db";
import { setupMemberCounterChannelsAction } from "@/actions/memberCounter";
...
const COUNTER_TYPES: { label: string; value: CounterType; icon: any; defaultTemplate: string }[] = [
...
export function MemberCounterBody({
    ...
    const handleUpdateCounter = (id: string, key: keyof CounterChannel, value: any) => {
        setConfig({
            ...config,
    ...
    const handleAutoCreateChannels = async (targetCounterId?: string) => {
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <select
                                                ...
                                                onChange={(e) => handleUpdateCounter(counter.id, "counterType", e.target.value as CounterType)}
