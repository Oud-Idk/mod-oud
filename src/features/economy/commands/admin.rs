...
use crate::features::economy::{add_cash, commands, deduct_cash, ensure_balance, get_balance};
...
pub async fn take(
    ...
    let Some(balance) = deduct_res else {
...
async fn send_balance_embed(
    ...
    let embed = CreateEmbed::new()
        ...
        .field(
            "Total",
            format!("{} {currency_name}", balance.total()),
            false,
        )
        .color(BRAND_COLOR);
