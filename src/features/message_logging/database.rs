...
pub async fn insert_deleted_message(db: &PgPool, msg: &MessageDetails, g_id: u64, joined_image_urls: &str, deleted_by: &Option<(u64, String)>) -> Result<PgQueryResult, sqlx::Error> {
    sqlx::query!(
        r#"
...
pub async fn insert_modified_messages(db: &PgPool, edit_details: &EditDetails, g_id: u64) -> Result<PgQueryResult, sqlx::Error> {
    sqlx::query!(
        r#"
